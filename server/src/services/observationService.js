...
exports.calculateObservationDayAndShift = void 0;
const calculateObservationDayAndShift = (registrationDate, serverTime = new Date()) => {
    // Calculate Day
    ...
    // 06:00 to 17:59 = M
    const shift = (currentHour >= 6 && currentHour < 18) ? 'M' : 'E';
    return { day, shift, serverTime };
};
exports.calculateObservationDayAndShift = calculateObservationDayAndShift;
//# sourceMappingURL=observationService.js.map